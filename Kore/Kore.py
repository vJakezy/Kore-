...
if len(sys.argv) < 4:
    print("\x1b[31mIncorrect Usage! python 34mKore.py fff [IP] [SHPREFIX] [DIRNAME]\x1b[0m")
    sys.exit()
...
print "\t\x1b[1;33m[\x1b[1;34mKore\x1b[1;33m]"
